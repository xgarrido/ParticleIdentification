...
namespace snemo {
  ...
  namespace datamodel {
    ...
    virtual void topology_2e_pattern::build_measurement_dictionary(snemo::datamodel::base_topology_pattern::particle_tracks_dict_type & particle_tracks_dict, snemo::datamodel::base_topology_pattern::measurement_dict_type & meas_dict_)
    {
      //temporary ?
      const snemo::datamodel::particle_track & e1 = particle_tracks_dict["e1"];
      const snemo::datamodel::particle_track & e2 = particle_tracks_dict["e2"];
