/// \file falaise/snemo/datamodels/topology_1e1g_pattern.h
/* Author(s) :    François Mauger <mauger@lpccaen.in2p3.fr>
 * Creation date: 2012-03-19
 * Last modified: 2014-01-27
 *
 * Description: The 1e1g class of trajectory patterns
 */

#ifndef FALAISE_SNEMO_DATAMODEL_TOPOLOGY_1E1G_PATTERN_H
#define FALAISE_SNEMO_DATAMODEL_TOPOLOGY_1E1G_PATTERN_H 1
...
namespace snemo {
  ...
  namespace datamodel {
    ...
    /// \brief The 1e1g class of reconstructed topology
    class topology_1e1g_pattern : public base_topology_pattern
    {
    public:
      ...
      /// Constructor
      topology_1e1g_pattern();

      /// Destructor
      virtual ~topology_1e1g_pattern();
...
BOOST_CLASS_EXPORT_KEY2(snemo::datamodel::topology_1e1g_pattern,
                        "snemo::datamodel::topology_1e1g_pattern")

#endif // FALAISE_SNEMO_DATAMODEL_TOPOLOGY_1E1G_PATTERN_H
