/// \file falaise/snemo/datamodels/topology_2e1a_pattern.h
/* Author(s) :    François Mauger <mauger@lpccaen.in2p3.fr>
 * Creation date: 2012-03-19
 * Last modified: 2014-01-27
 *
 * Description: The 2e1a class of trajectory patterns
 */

#ifndef FALAISE_SNEMO_DATAMODEL_TOPOLOGY_2E1A_PATTERN_H
#define FALAISE_SNEMO_DATAMODEL_TOPOLOGY_2E1A_PATTERN_H 1
...
namespace snemo {
  ...
  namespace datamodel {
    ...
    /// \brief The 2e1a class of reconstructed topology
    class topology_2e1a_pattern : public base_topology_pattern
    {
    public:
      ...
      /// Constructor
      topology_2e1a_pattern();

      /// Destructor
      virtual ~topology_2e1a_pattern();
...
BOOST_CLASS_EXPORT_KEY2(snemo::datamodel::topology_2e1a_pattern,
                        "snemo::datamodel::topology_2e1a_pattern")

#endif // FALAISE_SNEMO_DATAMODEL_TOPOLOGY_2E1A_PATTERN_H
